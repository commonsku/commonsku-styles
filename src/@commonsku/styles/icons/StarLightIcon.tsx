...
export default function StarLightIcon({
  color = teal.main,
  size = "medium",
  altText = "Search",
  ...props
  ...
  return (
    <SVG size={size} aria-labelledby="StarLightIcon" iconSizes={iconSizes} {...props}>
      <g id="light" transform="matrix(0.357231,0,0,0.357231,-1.53898,1.04263)">
